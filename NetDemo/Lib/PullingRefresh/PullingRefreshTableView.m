...
//        _dateLabel.text = NSLocalizedString(@"最后更新", @"");
        ...
        _arrow.contents = (id)[UIImage imageWithCGImage:[UIImage imageNamed:@"grayArrow.png"].CGImage scale:1 orientation:UIImageOrientationDown].CGImage;
...
//    x = 0;
    ...
    if (self.isAtTop) {
        ...
        UIImage *arrow = [UIImage imageNamed:@"grayArrow"];
        ...
        UIImage *arrow = [UIImage imageNamed:@"release-to-refresh"];        
        _arrow.contents = (id)arrow.CGImage;
