...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        [goodbtn setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 35)];
        [goodbtn setImage:[UIImage imageNamed:@"icon_for_good.png"] forState:UIControlStateNormal];
        [goodbtn setTitleEdgeInsets:UIEdgeInsetsMake(0, 0, 0, -18)];
       ...
       badbtn = [UIButton buttonWithType:UIButtonTypeCustom];
        ...
        [badbtn setTitleEdgeInsets:UIEdgeInsetsMake(0, 0, 0, -18)];
        [badbtn setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 35)];
        ...
        [commentsbtn setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 0, 35)];
        [commentsbtn setTitleEdgeInsets:UIEdgeInsetsMake(0, 0, 0, -18)];
